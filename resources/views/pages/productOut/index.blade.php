...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="card">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            class="dropdown-item"
                            data-bs-toggle="modal"
                            data-bs-target="#exLargeModalEdit{{ $data->kode_transaksi_keluar }}">
                        ...
                        <button
                          ...
                          class="dropdown-item"
                          data-bs-toggle="modal"
                          data-bs-target="#modalScrollableDelete{{ $data->kode_transaksi_keluar }}">
            ...
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-2">
                      <div class="col mb-0">
                        <label for="emailExLarge" class="form-label">Jumlah Keluar</label>
          ...
          {{-- Edit --}}
          @foreach ($productOut as $data)
          <div class="modal fade" id="exLargeModalEdit{{ $data->kode_transaksi_keluar }}" tabindex="-1" aria-hidden="true">
              <form method="POST" enctype="multipart/form-data" action="{{ route('productOut.update', $data->kode_transaksi_keluar) }}">
                @csrf
                @method('PUT')
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
          ...
          @foreach ($productOut as $data)
            <!-- Modal -->
            <div class="modal fade" id="modalScrollableDelete{{ $data->kode_transaksi_keluar }}" tabindex="-1" aria-hidden="true">
               <div class="modal-dialog modal-dialog-scrollable" role="document">
                 <div class="modal-content">
                   <div class="modal-header">
                     <h5 class="modal-title" id="modalScrollableTitle">Hapus Transaksi {{ $data->kode_transaksi_keluar }}</h5>
                     <button
                       type="button"
                       class="btn-close"
                       data-bs-dismiss="modal"
                   ...
                   <div class="modal-footer">
                     ...
                     <form method="POST" action="{{ route('productOut.destroy', $data->kode_transaksi_keluar) }}">
                       @csrf
                       @method('DELETE')
